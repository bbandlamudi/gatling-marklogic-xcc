...
object XccMarkLogicProtocolBuilder {

  val DefaultXccProtocolBuilder = new XccMarkLogicProtocolBuilder(XccMarkLogicProtocol.DefaultXccProtocol)

  implicit def toXccProtocol(builder: XccMarkLogicProtocolBuilder): XccMarkLogicProtocol = builder.build
